    ...
    <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-2 mb-8 text-center">
          ...
          <h2 className="text-2xl font-extrabold tracking-tighter mt-2">Welcome back</h2>
          <p className="text-xs text-gray-400">Sign in to resume tracking and monitoring your bento category scopes.</p>
        </div>
